                    ...
                    <form action="confirm.php" method="POST">
                        ...
                        <div class="form-row ">
                            <div class="form-group col-lg-4">
                                ...
                                <input type="text" class="form-control" id="inputPatientName" name="patientName" placeholder="">
                            </div>
                            <div class="form-group col-lg-4">
                        ...
                        <div class="form-row ">
                            <div class="form-group col-lg-4">
                                ...
                                <input type="tel" class="form-control" id="inputPhone" name="phone" placeholder="XXXXXXXXXX">
                            </div>
                            <div class="form-group col-lg-4">
