<?php
   ...
   /**
 * Prints the testimonial section HTML structure based on provided testimonials.
 *
 * @param array $testimonials An array containing testimonial information.
 */
function printTestimonialSection($testimonials) {
    // Start of testimonial section HTML structure
    ...
    // Loop through each testimonial and print its HTML structure
    foreach ($testimonials as $index => $testimonial) {
        $activeClass = ($index == 0) ? ' active' : ''; // Determine if the testimonial is active
    ...
    // End of testimonial section HTML structure
    echo '</div>
